...
const Experiences: React.FC = () => {
  return (
    <section className="min-h-screen bg-navy dark:text-gray-100 flex items-center justify-center snap-start p-8">
      <div className="container max-w-5xl px-4 mx-auto w-full">
