...
export default function Hello() {
  ...
  React.useEffect(() => {
    const h1 = document.querySelector(".welcome-title");
    if (!h1) return;
  ...
  return (
    <div className="min-h-screen bg-gray-900 py-20 flex items-center justify-center snap-start overflow-hidden" suppressHydrationWarning>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-1/2 lg:w-2/3 pl-[150px]">
            <div className="flex flex-col">
              <h1 className="text-4xl md:text-6xl lg:text-7xl text-white font-bold mb-2 welcome-title" suppressHydrationWarning>
              </h1>
              <span className="text-4xl md:text-6xl lg:text-7xl text-indigo-500 font-bold animate-fade-in">Portfolio</span>
            </div>
            <p className="text-lg md:text-xl lg:text-2xl text-gray-400 mb-8 animate-slide-in-left delay-1">
              Lets Discover who i am
            </p>
            <div className="flex gap-2 animate-slide-in-left delay-2">
              <a 
                href="#about" 
                className="bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-3 px-6 rounded-md transition-all duration-300 hover:shadow-lg hover:shadow-indigo-500/50"
              >
                Get Started
              </a>
            </div>
              ...
              <div className="relative">
                <div className="flex flex-col items-center justify-center">
                  <Avatar className="h-52 w-52 rounded-full ring-8 ring-blue-500 ring-offset-4 ring-offset-gray-900 overflow-hidden">
                    ...
                    />
                    <AvatarFallback>OBA</AvatarFallback>
                  </Avatar>
                  ...
                  {/* CTA Buttons */}
                  <div className="mt-8 flex space-x-4 animate-slide-in-up delay-3">
                    <Button className="bg-white text-black border border-transparent hover:bg-black hover:text-white transition-all duration-300 hover:shadow-lg hover:shadow-white/20">
                      <svg
